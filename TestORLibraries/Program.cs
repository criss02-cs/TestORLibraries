...
var ibmSolver = new IbmSolver();
ibmSolver.Solve(allJobs, horizon, numMachines, allMachines);

var gurobiSolver = new GurobiSolver();
gurobiSolver.Solve(allJobs, horizon, numMachines, allMachines);
